 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://server.ws.sheliming.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://server.ws.sheliming.com/", "HelloWSImplService");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://server.ws.sheliming.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ws.sheliming.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
